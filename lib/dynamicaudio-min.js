var swfobject = function() {
    var m = "undefined", t = "object", W = "Shockwave Flash", bh = "ShockwaveFlash.ShockwaveFlash", F = "application/x-shockwave-flash", X = "SWFObjectExprInst", Y = "onreadystatechange", r = window, i = document, w = navigator, Z = false, G = [bi], x = [], H = [], B = [], D, I, O, ba, z = false, J = false, u, P, bb = true, f = function() {
        var a = typeof i.getElementById != m && typeof i.getElementsByTagName != m && typeof i.createElement != m
          , c = w.userAgent.toLowerCase()
          , b = w.platform.toLowerCase()
          , d = b ? /win/.test(b) : /win/.test(c)
          , g = b ? /mac/.test(b) : /mac/.test(c)
          , j = /webkit/.test(c) ? parseFloat(c.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : false
          , h = !+"\v1"
          , o = [0, 0, 0]
          , l = null;
        ...
        if ((typeof i.readyState != m && i.readyState == "complete") || (typeof i.readyState == m && (i.getElementsByTagName("body")[0] || i.body))) {
            C()
        }
        if (!z) {
            if (typeof i.addEventListener != m) {
                i.addEventListener("DOMContentLoaded", C, false)
            }
            if (f.ie && f.win) {
                i.attachEvent(Y, function() {
                    if (i.readyState == "complete") {
                        i.detachEvent(Y, arguments.callee);
                        C()
                    }
                });
                if (r == top) {
    ...
    function C() {
        ...
        try {
            var a = i.getElementsByTagName("body")[0].appendChild(y("span"));
    ...
    function bc(a) {
        ...
        } else if (typeof i.addEventListener != m) {
                ...
                if (f.pv[0] > 0) {
                    ...
                    if (j) {
                        if (K(x[c].swfVersion) && !(f.wk && f.wk < 312)) {
                            ...
                            h.width = j.getAttribute("width") || "0";
                            h.height = j.getAttribute("height") || "0";
                            if (j.getAttribute("class")) {
                                h.styleclass = j.getAttribute("class")
                            }
                            if (j.getAttribute("align")) {
                                h.align = j.getAttribute("align")
                            }
                            var o = {};
                            var l = j.getElementsByTagName("param");
                            var q = l.length;
                            for (var p = 0; p < q; p++) {
    ...
    function T(a, c, b, d) {
        ...
        if (g) {
            ...
            var j = f.ie && f.win ? "ActiveX" : "PlugIn"
              , h = "MMredirectURL=" + r.location.toString().replace(/&/g, "%26") + "&MMplayerType=" + j + "&MMdoctitle=" + i.title;
        ...
        if (f.win && f.ie) {
            ...
            if (b) {
                ...
                if (d) {
                    var g = d.length;
                    for (var j = 0; j < g; j++) {
                        if (!(d[j].nodeType == 1 && d[j].nodeName == "PARAM") && !(d[j].nodeType == 8)) {
                            c.appendChild(d[j].cloneNode(true))
                        }
                    }
                }
            }
    ...
    function V(a, c, b) {
        ...
        if (g) {
            ...
            if (f.ie && f.win) {
                ...
                g.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + j + '>' + o + '</object>';
                H[H.length] = a.id;
                d = s(a.id)
            } else {
                var q = y(t);
    ...
    function bf(a, c, b, d) {
        ...
        if (!u || P != j) {
            ...
            u = g.appendChild(h);
            if (f.ie && f.win && typeof i.styleSheets != m && i.styleSheets.length > 0) {
                u = i.styleSheets[i.styleSheets.length - 1]
            }
            P = j
        }
        if (f.ie && f.win) {
            ...
            if (u && typeof i.createTextNode != m) {
                u.appendChild(i.createTextNode(a + " {" + c + "}"))
            }
        }
    }
    function A(a, c) {
    ...
    return {
        ...
        embedSWF: function(j, h, o, l, q, p, v, L, M, E) {
            var N = {
                success: false,
                id: h
            };
            if (f.w3 && !(f.wk && f.wk < 312) && j && h && o && l && q) {
                A(h, false);
                bd(function() {
                    o += "";
                    l += "";
        ...
        getQueryParamValue: function(a) {
            var c = i.location.search || i.location.hash;
            if (c) {
                if (/\?/.test(c)) {
                    c = c.split("?")[1]
                }
...
DynamicAudio.prototype = {
    ...
    init: function(c) {
        ...
        if (typeof Audio != 'undefined') {
            b.audioElement = new Audio();
            if (b.audioElement.mozSetup) {
                b.audioElement.mozSetup(2, 44100, 1);
                return
            }
        }
        b.audioElement = null;
    ...
    write: function(a) {
        if (this.audioElement != null) {
            this.audioElement.mozWriteAudio(a.length, a)
        } else if (this.flashElement != null) {
            var c = new Array(a.length);
            for (var b = a.length - 1; b != 0; b--) {
                c[b] = Math.floor(a[b] * 32768)
            }
    ...
    writeInt: function(a) {
        if (this.audioElement != null) {
            ...
            this.audioElement.mozWriteAudio(c.length, c)
        } else if (this.flashElement != null) {
